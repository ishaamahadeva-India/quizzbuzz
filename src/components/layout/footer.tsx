    ...
    <footer className="hidden md:block border-t bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 md:py-4">
        <div className="flex flex-col items-center justify-center gap-3 text-xs">
          {/* Short Footer Disclosure */}
          <p className="text-center text-muted-foreground font-medium max-w-2xl">
            Free-to-play skill-based contests with sponsor-funded non-cash rewards. No entry fee. No cash prizes.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 md:gap-4 text-muted-foreground">
